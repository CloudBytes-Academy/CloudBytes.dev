...
description: "Detailed step by step guide on how to use SAM CLI to build serverless apps."
pubDate: "2021-08-02"
category: "Snippets"
categorySlug: "snippets"
slug: "build-deploy-serverless-apps-on-aws-with-sam-cli"
tags:
    - "aws"
    - "python"
keywords:
...
![AWS Lambda API Gateway Hello world](/images/99999984-sam-getting-started-hello-world.png)
...
![Create an AWS IAM user](/images/99999984-aws-iam-type.png)
...
![AWS New IAM User](/images/99999984-aws-new-iam-user.png)
