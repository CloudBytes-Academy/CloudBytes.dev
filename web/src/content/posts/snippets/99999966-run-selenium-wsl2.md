...
description: "A guide to installating, configuring and running Selenium and Chrome for Testing on Windows Subsystem for Linux (WSL2) and run tests using Python and Selenium webdriver."
pubDate: "2023-12-05"
category: "Snippets"
...
![Install WSL](/images/99999966-install-wsl.gif)
...
```
![chrome-version](/images/99999966-03-chrome-version.png)
...
![run-selenium](/images/99999966-run-selenium.png)
