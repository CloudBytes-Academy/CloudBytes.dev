...
description: "How to receive a file to the in-memory buffer and then return the file from buffer using FastAPI without saving it to disk."
pubDate: "2021-10-15"
category: "Snippets"
categorySlug: "snippets"
slug: "received-return-a-file-from-in-memory-buffer-using-fastapi"
tags:
    - "python"
    - "fastapi"
keywords:
...
![Uvicorn run](/images/99999975-uvicorn_run.png)
...
![Swagger UI](/images/99999975-swagger_ui.png)
...
![Blurred Cat](/images/99999975-cat_pic.jpg)
