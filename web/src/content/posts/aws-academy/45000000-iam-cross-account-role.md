...
description: "Access another AWS account temporarily using an IAM role and STS"
pubDate: "2022-08-13"
category: "AWS Academy"
categorySlug: "aws-academy"
slug: "cross-account-access-to-aws-services-using-iam-roles"
tags:
    - "aws"
keywords:
    - "AWS"
...
![Cross account access using role](/images/aws/45000000-01-cross-account-access.png)
...
![Select trusted entity aws iam](/images/aws/45000000-02-select-trusted-entity.png)
...
![Trusted account policy](/images/aws/45000000-03-trusted-account-policy.png)
...
![Attach policy to user](/images/aws/45000000-04-attach-permission.png)
...
![Assume role in trusted account](/images/aws/45000000-05-switch-role-success.png)
