...
description: "Use AWS Database Migration Service (DMS) to migrate a database to Amazon RDS by configuring a replication instance, source and target endpoints, and a migration task."
pubDate: "2024-03-03"
category: "AWS Academy"
categorySlug: "aws-academy"
slug: "migrate-a-db-to-rds-using-aws-database-migration-service-dms"
tags:
    - "aws"
keywords:
    - "AWS"
