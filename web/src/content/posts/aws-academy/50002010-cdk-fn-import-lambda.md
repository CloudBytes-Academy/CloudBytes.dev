...
description: "A guide to importing an existing lambda function using AWS CDK in Python and applying changes to it"
pubDate: "2023-11-05"
category: "AWS Academy"
categorySlug: "aws-academy"
slug: "how-to-import-an-existing-lambda-function-using-aws-cdk-in-python"
tags:
    - "aws"
    - "cdk"
    - "python"
