...
![S3 event notifications](/images/50001050-02-event-notification-options.png)
...
![S3 event bridge notification](/images/50001050-01-event-bridge-s3-notification.png)


### Test the app
Let's upload a file to the S3 bucket and see if the Lambda function is invoked.

![S3 upload file](/images/50001050-03-upload-to-s3.gif)

If you check your CloudWatch logs, you will see that the Lambda function was invoked and it printed "File uploaded!".

![S3 upload event bridge notification](/images/50001050-04-event-bridge-success.png)
